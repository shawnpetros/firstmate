...
Its supervisor injection path supports tmux, herdr, and Orca panes, with `FM_SUPERVISOR_BACKEND` and `FM_SUPERVISOR_TARGET` resolved independently from the task-spawn backend.
