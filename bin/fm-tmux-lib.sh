...
FM_TMUX_BUSY_REGEX_DEFAULT='esc (to )?interrupt|Working\.\.\.|Ctrl\+c:cancel|Running[[:space:]]+[0-9]+[[:space:]]+tokens'
...
FM_TMUX_CURSOR_BUSY_REGEX_DEFAULT='Running[[:space:]]+[0-9]+[[:space:]]+tokens'
